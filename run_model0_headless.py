"""
run_model0_headless.py
Drives the M0-REACTIVE simulation logic headlessly (no display required).
Runs 3 environment configurations and saves 3 Excel files:
  model0_reactive_domestic_<ts>.xlsx
  model0_reactive_mix_<ts>.xlsx
  model0_reactive_warehouse_<ts>.xlsx
"""
...
def save_to_excel(cfg_name):
    ...
    out = f"model0_reactive_{cfg_name}_{date_str}.xlsx"
